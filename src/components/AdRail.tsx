...
export const AdRail = ({ position }: { position: "left" | "right" }) => {
  ...
  return (
    <aside className="hidden xl:flex flex-col gap-3 w-44 shrink-0">
      ...
      <div className="h-[calc(100vh-220px)] max-h-[760px] min-h-[440px] overflow-hidden rounded-2xl border bg-white/80 backdrop-blur shadow-soft p-2">
...
export const DesktopAdRails = () => (
  <div className="hidden xl:block pointer-events-none">
    <div className="fixed left-4 top-[180px] bottom-20 z-20 pointer-events-auto"><AdRail position="left" /></div>
    <div className="fixed right-4 top-[180px] bottom-20 z-20 pointer-events-auto"><AdRail position="right" /></div>
  </div>
);
