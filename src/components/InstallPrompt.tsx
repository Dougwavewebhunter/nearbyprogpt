...
export const InstallPrompt = () => {
  ...
  useEffect(() => {
    ...
    const handler = (e: any) => { e.preventDefault(); setEvt(e); setTimeout(() => setShow(true), 20000); };
    ...
    <div className="fixed bottom-4 inset-x-4 md:left-auto md:right-6 md:w-96 z-50 bg-card border rounded-2xl shadow-elegant p-4 animate-fade-in">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="text-xs text-muted-foreground">Install this app on Android, iOS or Windows for one-tap access.</div>
        </div>
