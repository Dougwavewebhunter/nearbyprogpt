...
import { MapPin, Star, MessageSquare, Image as ImageIcon } from "lucide-react";
      ...
      <main className="container py-8 flex-1 grid lg:grid-cols-3 gap-6">
        ...
        <aside className="space-y-4">
          <Card className="p-6 space-y-3 sticky top-24">
            ...
            <p className="text-[11px] text-muted-foreground text-center">All conversations stay inside NearbyPro to keep you safe. No external phone or WhatsApp shared.</p>
          </Card>
        </aside>
      </main>
      <Footer />
